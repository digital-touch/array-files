<template>
    <panel-item :field="field">
        <div slot="value" class="flex flex-row overflow-x-auto py-2">
              <div class="p-2 m-2 rounded shadow-md p-2 m-2 rounded shadow-md flex flex-row items-center justify-center flex-1 text-primary px-1 pb-2"
                ...
                <a :href="file.url"
                   class="inline-block m-2 p-2 text-base text-left text-primary no-underline w-full"
